...
sed -i --quiet "s/DB_NAME_HANDLE/${CLI_DATABASE_NAME}/g" /$WEBSITE_INSTALL_DIRECTORY/$CLI_WEBSITE/public/wp-config.php
sed -i --quiet "s/DB_USER_HANDLE/${CLI_DATABASE_USER}/g" /$WEBSITE_INSTALL_DIRECTORY/$CLI_WEBSITE/public/wp-config.php
sed -i --quiet "s/DB_PASSWORD_HANDLE/${CLI_DATABASE_PASSWORD}/g" /$WEBSITE_INSTALL_DIRECTORY/$CLI_WEBSITE/public/wp-config.php
sed -i --quiet "s/TABLE_PREFIX_HANDLE/${CLI_PREFIX_RANDOM}/g" /$WEBSITE_INSTALL_DIRECTORY/$CLI_WEBSITE/public/wp-config.php
...
sed -i --quiet "s/BACKEND_PATH_HANDLE/${CLI_BACKEND_PATH}/g" /$WEBSITE_INSTALL_DIRECTORY/$CLI_WEBSITE/public/wp-config.php
...
sed -i --quiet "s/REPLACETHIS/${CLI_WEBSITE}/g" /$NGINX_CONF_DIR/conf.d/$CLI_WEBSITE.conf
sed -i --quiet "s/BACKENDPATH/${CLI_BACKEND_PATH}/g" /$NGINX_CONF_DIR/conf.d/$CLI_WEBSITE.conf
# Chown it up here.
