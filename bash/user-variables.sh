...
# Website lists
declare -a wordpress_multisite_list=( 'megabyte.io' 'bestwebapps.net' 'enviedsolutions.com' 'bestmetroapps.com' 'thebestsites.com' ) # First website in list is the primary domain
