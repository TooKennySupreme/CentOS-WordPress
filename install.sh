...
echo "Instructions:"
echo ""
echo "$(tput bold)$(tput setaf 2)1. Edit the file located at /usr/local/src/megabyteio/bash/user-variables.sh with your own information.$(tput sgr0)"
echo "$(tput bold)$(tput setaf 2)2. Run the fully automated installation by entering the following command: /bin/bash /usr/local/src/megabyteio/bash/setup.sh$(tput sgr0)"
